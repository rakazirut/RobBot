    ...
    .addFields(
      {
        name: "!account:",
        value:
          `Returns information related to the user account.\n` +
          `**Example:** !account WhiskeyRomeo#1730`,
      },
      {
        name: "!hero:",
        value:
          "Returns information related to the specified hero for an account.\n" +
          `**Example:** !hero WhiskeyRomeo#1730 BackClapper`,
      },
      {
        name: "!hcl:",
        value:
          `Returns (if applicable) the Solo GR Leaderboard position for the specified hero and season.\n` +
          `**Example:** !hcl WhiskeyRomeo#1730 BackClapper 20`,
      },
      {
        name: "!skill_list:",
        value:
          `Returns list of skills for the given class\n` +
      ...
      },
      {
        name: "!skill_detail:",
        value:
          `Returns additional detail of skill for the given class\n` +
